...
template <>
struct PrototypeIDMap<mozilla::dom::ElementReplaceEvent>
{
  enum
  {
    PrototypeID = prototypes::id::ElementReplaceEvent
  };
};
} // namespace dom
} // namespace mozilla
...
struct ElementReplaceEventInitInitializer : public ElementReplaceEventInit
{
  inline ElementReplaceEventInitInitializer()
  {
...
namespace ElementReplaceEventBinding {
  ...
  inline JS::Handle<JSObject*> GetProtoObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    if (!protoAndIfaceArray[prototypes::id::ElementReplaceEvent]) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
    }

    /* The object might _still_ be null, but that's OK */
    return JS::Handle<JSObject*>::fromMarkedLocation(&protoAndIfaceArray[prototypes::id::ElementReplaceEvent]);
  }
  ...
  inline JS::Handle<JSObject*> GetConstructorObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    if (!protoAndIfaceArray[constructors::id::ElementReplaceEvent]) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
    }

    /* The object might _still_ be null, but that's OK */
    return JS::Handle<JSObject*>::fromMarkedLocation(&protoAndIfaceArray[constructors::id::ElementReplaceEvent]);
  }
